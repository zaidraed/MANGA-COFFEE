...
export default {
  ...
  //------mongodb------//
  Db: process.env.URI || "mongodb://localhost:27017/mangacoffe",
  //------.gooogle-----//
  ...
  CLIENTD_REFRESHTOKEN:
    "1//04L1CLCD8L-VgCgYIARAAGAQSNwF-L9IrdETXIa9zD6W-UrRmXA2n0HKetgV-Wgd9uP-B3c2e84uIxwVo_Fd2wxhsqMJvo_5ATy8",

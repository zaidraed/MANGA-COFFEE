...
const Chat = () => {
    ...
    MySwal.fire({
      html: (
        <>
          ...
          <h3>Check your e-mail to verify your account</h3>
        </>
      ),
  ...
  return (
    ...
    <div
      id="chat-app"
      className={mQuery.matches ? "chat-app" : "chat-app is-active"}
    >
      <motion.div
      ...
      <div className="chat-app_box">
        <div
          className={
            minimized ? "chat-container" : "chat-container is-minimized"
          }
        >
          <div className="chat-up" onClick={minimizedChat}>
            {user.user ? (
            ...
            <button onClick={() => a("#chat-app")} id="close" className="btn">
              xcv
            </button>
          </div>
